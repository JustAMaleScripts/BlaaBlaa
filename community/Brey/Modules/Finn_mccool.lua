...
-- Place in: UhhhhhhReanim/Modules/Finn_mccool.lua
...
(That fucking superboss that i hate)"
    ...
    m.Assets = {
        "finnidle.anim",
        "finnwalk.anim",
        "finnbatsmackdown.anim",
        "finnbaseballshot.anim",
        "finncharge.anim",
        "finnbatcombo.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Finn mccool", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "finnidle.anim", true),
        walk = loadAnim(figure, "finnwalk.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["smackdown"] = loadAnim(figure, "finnbatsmackdown.anim", false),
        ["baseball shot"] = loadAnim(figure, "finnbaseballshot.anim", false),
        ["charge"] = loadAnim(figure, "finncharge.anim", false),
        ["Combo"] = loadAnim(figure, "finnbatcombo.anim", false),
        }
        ...
        ContextActions:BindAction("GM_baseball_shot", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("baseball shot") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_baseball_shot", "baseball shot")
        ContextActions:SetPosition("GM_baseball_shot", UDim2.new(1, -230, 1, -130))
        ...
        ContextActions:SetPosition("GM_charge", UDim2.new(1, -230, 1, -190))
        ...
        ContextActions:SetPosition("GM_Combo", UDim2.new(1, -290, 1, -190))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_baseball_shot")
