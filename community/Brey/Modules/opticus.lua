...
-- Place in: UhhhhhhReanim/Modules/opticus.lua
...
AddModule(function()
    ...
    m.Name         = "opticus"
    m.Description  = "\"ill do better training my students..\""
    m.InternalName = "opticus"

    m.Assets = {
        "opticusidle.anim",
        "opticuswalk.anim",
        "opticusstab.anim",
        "opticusportalstab.anim",
        "opticusuppercutportal.anim",
        "opticuskickcombo.anim",
        "opticusbrokenback.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "opticus", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "opticusidle.anim", true),
        walk = loadAnim(figure, "opticuswalk.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["stab"] = loadAnim(figure, "opticusstab.anim", false),
        ["portal"] = loadAnim(figure, "opticusportalstab.anim", false),
        ["uppercut"] = loadAnim(figure, "opticusuppercutportal.anim", false),
        ["Kick combo"] = loadAnim(figure, "opticuskickcombo.anim", false),
        ["Back broke"] = loadAnim(figure, "opticusbrokenback.anim", false),
        }
        ...
        ContextActions:BindAction("GM_stab", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("stab") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_stab", "stab")
        ContextActions:SetPosition("GM_stab", UDim2.new(1, -190, 1, -130))

        ContextActions:BindAction("GM_portal", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("portal") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_portal", "portal")
        ContextActions:SetPosition("GM_portal", UDim2.new(1, -230, 1, -130))

        ContextActions:BindAction("GM_uppercut", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("uppercut") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_uppercut", "uppercut")
        ContextActions:SetPosition("GM_uppercut", UDim2.new(1, -230, 1, -180))

        ContextActions:BindAction("GM_Kick_combo", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Kick combo") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Kick_combo", "Kick combo")
        ContextActions:SetPosition("GM_Kick_combo", UDim2.new(1, -270, 1, -130))

        ContextActions:BindAction("GM_Back_broke", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Back broke") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Back_broke", "Back broke")
        ContextActions:SetPosition("GM_Back_broke", UDim2.new(1, -190, 1, -180))
    end
    ...
    m.Destroy = function(figure)
        ContextActions:UnbindAction("GM_stab")
        ContextActions:UnbindAction("GM_portal")
        ContextActions:UnbindAction("GM_uppercut")
        ContextActions:UnbindAction("GM_Kick_combo")
        ContextActions:UnbindAction("GM_Back_broke")
