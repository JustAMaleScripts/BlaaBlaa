-- griefers_madness.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/griefers_madness.lua
...
AddModule(function()
    ...
    m.Name         = "griefers madness"
    m.Description  = "\"2020, july 8th. Griefers obsession with the venomshank has came back again..\""
    m.InternalName = "griefers_madness"

    m.Assets = {
        "griefermadnessidle.anim",
        "grieferwalk.anim",
        "grieferslam.anim",
        "grieferslam2.anim",
        "griefersmack.anim",
        "griefershankslice.anim",
        "griefershankspin.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "griefers madness", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "griefermadnessidle.anim", true),
        ...
        ["slice"] = loadAnim(figure, "griefershankslice.anim", false),
        ["Spin dance"] = loadAnim(figure, "griefershankspin.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_slam2", UDim2.new(1, -230, 1, -170))
        ...
        ContextActions:SetPosition("GM_smackdown", UDim2.new(1, -170, 1, -130))

        ContextActions:BindAction("GM_slice", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("slice") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_slice", "slice")
        ContextActions:SetPosition("GM_slice", UDim2.new(1, -290, 1, -170))

        ContextActions:BindAction("GM_Spin_dance", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Spin dance") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Spin_dance", "Spin dance")
        ContextActions:SetPosition("GM_Spin_dance", UDim2.new(1, -290, 1, -130))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_slice")
        ContextActions:UnbindAction("GM_Spin_dance")
