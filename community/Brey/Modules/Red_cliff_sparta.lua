-- Red_cliff_sparta.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/Red_cliff_sparta.lua
...
AddModule(function()
    ...
    m.Name         = "Red cliff sparta"
    m.Description  = "\"the brave warriors of the redcliff empire. Known to have brutal trainings and more..\""
    m.InternalName = "Red_cliff_sparta"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Red cliff sparta", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "spartaidle.anim", true),
        walk = loadAnim(figure, "Spartawalk.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Slash"] = loadAnim(figure, "spartaslash.anim", false),
        ["bash"] = loadAnim(figure, "spartabash.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_Slash", UDim2.new(1, -180, 1, -130))
