...
-- Place in: UhhhhhhReanim/Modules/Sky_night.lua
...
AddModule(function()
    ...
    m.Name         = "Sky night"
    m.Description  = "\"one time, in the splintered heights.. there was a knight in the sky town.\""
    m.InternalName = "Sky_night"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Sky night", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        actionAnims = {
        ["Slash"] = loadAnim(figure, "knightslash.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_Slash", UDim2.new(1, -230, 1, -130))
    end
