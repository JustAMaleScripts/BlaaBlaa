-- Red_cliff_man_(3).lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/Red_cliff_man_(3).lua
...
AddModule(function()
    ...
    m.Name         = "Red cliff man (3)"
    m.Description  = "Red cliff man (3) if he was chill"
    m.InternalName = "Red_cliff_man_(3)"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Red cliff man (3)", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "axeidle.anim", true),
        walk = loadAnim(figure, "axewalk.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["combo"] = loadAnim(figure, "axecombo.anim", false),
        ["Bugle"] = loadAnim(figure, "axebugle.anim", false),
        ["Evasive"] = loadAnim(figure, "axeevasive.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_combo", UDim2.new(1, -190, 1, -130))

        ContextActions:BindAction("GM_Bugle", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Bugle") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Bugle", "Bugle")
        ContextActions:SetPosition("GM_Bugle", UDim2.new(1, -230, 1, -130))

        ContextActions:BindAction("GM_Evasive", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Evasive") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Evasive", "Evasive")
        ContextActions:SetPosition("GM_Evasive", UDim2.new(1, -280, 1, -130))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_Bugle")
        ContextActions:UnbindAction("GM_Evasive")
