-- KasaneTetoR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/KasaneTetoR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Kasane Teto R15 Moveset"
    m.Description  = "Kasane Teto R15 Animations"
    m.InternalName = "KasaneTetoR15Moveset"

    m.Assets = {
        "Kasane Teto Idle.anim",
        "Kasane Teto Walk.anim",
        "Kasane Teto Jump.anim",
        "Kasane Teto Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Kasane Teto R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Kasane Teto Idle.anim", true),
        walk = loadAnim(figure, "Kasane Teto Walk.anim", true),
        jump = loadAnim(figure, "Kasane Teto Jump.anim", true),
        sprint = loadAnim(figure, "Kasane Teto Run.anim", true),
        }
