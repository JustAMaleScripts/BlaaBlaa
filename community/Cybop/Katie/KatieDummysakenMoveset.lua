-- KatieDummysakenMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/KatieDummysakenMoveset.lua
...
AddModule(function()
    ...
    m.Description  = "A Great Artist, Has a Sign Named Connor"
    m.InternalName = "KatieDummysakenMoveset"

    m.Assets = {
        "KatieDummysaken Idle.anim",
        "KatieDummysaken Walk.anim",
        "KatieDummysaken Run.anim",
        "KatieDummysaken Punch.anim",
        "KatieDummysaken Connor Attack.anim",
        "KatieDummysaken Dash.anim",
        "KatieDummysaken Determination.anim",
    }
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "KatieDummysaken Idle.anim", true),
        walk = loadAnim(figure, "KatieDummysaken Walk.anim", true),
        sprint = loadAnim(figure, "KatieDummysaken Run.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Punch"] = loadAnim(figure, "KatieDummysaken Punch.anim", false),
        ["Connor Attack"] = loadAnim(figure, "KatieDummysaken Connor Attack.anim", false),
        ["Dash"] = loadAnim(figure, "KatieDummysaken Dash.anim", false),
        ["Determination"] = loadAnim(figure, "KatieDummysaken Determination.anim", false),
        }
        ...
        ContextActions:BindAction("GM_Punch", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Punch") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Punch", "Punch")
        ContextActions:SetPosition("GM_Punch", UDim2.new(1, -200, 1, -110))

        ContextActions:BindAction("GM_Connor_Attack", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Connor Attack") end
        end, true, Enum.KeyCode.X)
        ContextActions:SetTitle("GM_Connor_Attack", "Connor Attack")
        ContextActions:SetPosition("GM_Connor_Attack", UDim2.new(1, -160, 1, -110))
        ...
        ContextActions:SetPosition("GM_Dash", UDim2.new(1, -240, 1, -110))
        ...
        ContextActions:SetPosition("GM_Determination", UDim2.new(1, -280, 1, -110))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_Punch")
        ContextActions:UnbindAction("GM_Connor_Attack")
