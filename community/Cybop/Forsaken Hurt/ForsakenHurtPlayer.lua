-- ForsakenHurtPlayer.lua
-- Generated by Reanim Moveset Creator v5
-- Place in: UhhhhhhReanim/Modules/ForsakenHurtPlayer.lua
...
AddModule(function()
    ...
    m.Name         = "Forsaken Hurt Moveset"
    m.Description  = "This is the Hurt player animations."
    m.InternalName = "ForsakenHurtPlayer"

    -- ── ASSETS ────────────────────────────────────────────────────────────
    m.Assets = {
        "ForsakenNormalInjuredIdle.anim",
        "ForsakenNormalInjuredWalk.anim",
        "ForsakenNormalInjuredRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Forsaken Hurt Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "ForsakenNormalInjuredIdle.anim", true),
        walk   = loadAnim(figure, "ForsakenNormalInjuredWalk.anim", true),
        sprint   = loadAnim(figure, "ForsakenNormalInjuredRun.anim", true),
        }
