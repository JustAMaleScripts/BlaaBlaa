-- GlowMotionMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/GlowMotionMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Glow Motion R15"
    m.Description  = "Glow Motion Animation R15"
    m.InternalName = "GlowMotionMoveset"

    m.Assets = {
        "Glow Motion Idle.anim",
        "Glow Motion Walk.anim",
        "Glow Motion Jump.anim",
        "Glow Motion Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Glow Motion R15", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Glow Motion Idle.anim", true),
        walk = loadAnim(figure, "Glow Motion Walk.anim", true),
        jump = loadAnim(figure, "Glow Motion Jump.anim", true),
        sprint = loadAnim(figure, "Glow Motion Run.anim", true),
        }
