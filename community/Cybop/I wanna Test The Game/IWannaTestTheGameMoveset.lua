-- IWannaTestTheGameMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/IWannaTestTheGameMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "I Wanna Test The Game Moveset"
    m.Description  = "This Moveset is based in the animations player of the game I Wanna Test The Game"
    m.InternalName = "IWannaTestTheGameMoveset"

    m.Assets = {
        "IWannaTestTheGameIdle.anim",
        "IWannaTestTheGameWalkRun.anim",
        "IWannaTestTheGameJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "I Wanna Test The Game Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "IWannaTestTheGameIdle.anim", true),
        walk = loadAnim(figure, "IWannaTestTheGameWalkRun.anim", true),
        jump = loadAnim(figure, "IWannaTestTheGameJump.anim", true),
        }
