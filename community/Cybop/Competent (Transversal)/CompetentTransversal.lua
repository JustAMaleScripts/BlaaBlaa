...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Competent (Transversal)"
	m.Description  = "Now walks"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "walk Run", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "idk", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("CompetentTraversal.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Competent.mp3")
		sndConga.Volume  = 0.8
