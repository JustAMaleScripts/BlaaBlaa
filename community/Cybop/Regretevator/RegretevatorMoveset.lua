-- RegretevatorMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/RegretevatorMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Regretevator"
    m.Description  = "This is the base animations from the game Regretevator"
    m.InternalName = "RegretevatorMoveset"

    m.Assets = {
        "RegretevatorIdle.anim",
        "RegretevatorWalk.anim",
        "RegretevatorRun.anim",
        "RegretevatorJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Regretevator", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "RegretevatorIdle.anim", true),
        walk = loadAnim(figure, "RegretevatorWalk.anim", true),
        sprint = loadAnim(figure, "RegretevatorRun.anim", true),
        jump = loadAnim(figure, "RegretevatorJump.anim", true),
        }
