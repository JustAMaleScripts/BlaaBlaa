...
-- Place in: UhhhhhhReanim/Modules/CircuitMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Circuit"
    m.Description  = "Run for you life.. son..."
    m.InternalName = "CircuitMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Circuit", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "CircuitIdle.anim", true),
        walk = loadAnim(figure, "CircuitWalk.anim", true),
        sprint = loadAnim(figure, "CircuitRun.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("CircuitTheme.mp3", hrp, 0.5, true)
        bgSound:Play()
        setupChat()
