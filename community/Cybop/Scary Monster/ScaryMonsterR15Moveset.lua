-- ScaryMonsterR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ScaryMonsterR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Scary Monster R15 Moveset"
    m.Description  = "Scary Monster R15 Animations"
    m.InternalName = "ScaryMonsterR15Moveset"

    m.Assets = {
        "Scary Monster Idle.anim",
        "Scary Monster Walk.anim",
        "Scary Monster Jump.anim",
        "Scary Monster Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Scary Monster R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Scary Monster Idle.anim", true),
        walk = loadAnim(figure, "Scary Monster Walk.anim", true),
        jump = loadAnim(figure, "Scary Monster Jump.anim", true),
        sprint = loadAnim(figure, "Scary Monster Run.anim", true),
        }
