-- UhhhhhhReanim/Modules/BigBossWalkModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Big Boss Walk"
	m.Description  = "The Dance or walk of the Big Boss"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Big Boss!", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Boss..", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("BigBossWalk.anim"))
		...
		sndConga.SoundId = AssetGetContentId("BigBossWalkAudio.mp3")
		sndConga.Volume  = 0.8
