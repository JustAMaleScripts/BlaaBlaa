-- UhhhhhhReanim/Modules/Slides.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Slide"
	m.Description  = "Ultrakill Slide"
	m.InternalName = "ULTRAKILL_SLIDE"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Machine...", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "What", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("SlideTheAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("SlideSound.mp3")
		sndConga.Volume  = 0.8
