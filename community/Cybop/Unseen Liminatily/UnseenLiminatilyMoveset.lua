-- UnseenLiminatilyMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/UnseenLiminatilyMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Unseen Liminatily Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Unseen Liminatily"
    m.InternalName = "UnseenLiminatilyMoveset"

    m.Assets = {
        "UnseenLiminatilyIdle.anim",
        "UnseenLiminatilyWalk.anim",
        "UnseenLiminatilyJump.anim",
        "UnseenLiminatilyRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Unseen Liminatily Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "UnseenLiminatilyIdle.anim", true),
        walk = loadAnim(figure, "UnseenLiminatilyWalk.anim", true),
        jump = loadAnim(figure, "UnseenLiminatilyJump.anim", true),
        sprint = loadAnim(figure, "UnseenLiminatilyRun.anim", true),
        }
