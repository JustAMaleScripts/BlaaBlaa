-- OldSchoolR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/OldSchoolR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Old School R15 Moveset"
    m.Description  = "Old School R15 Animations"
    m.InternalName = "OldSchoolR15Moveset"

    m.Assets = {
        "Old School Idle.anim",
        "Old School Walk.anim",
        "Old School Jump.anim",
        "Old School Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Old School R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Old School Idle.anim", true),
        walk = loadAnim(figure, "Old School Walk.anim", true),
        jump = loadAnim(figure, "Old School Jump.anim", true),
        sprint = loadAnim(figure, "Old School Run.anim", true),
        }
