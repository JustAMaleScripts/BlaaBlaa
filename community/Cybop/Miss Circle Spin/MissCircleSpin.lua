...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Miss Circle Spin"
	m.Description  = "Spinn"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Spinnn", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Yayay", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("MissCircleSpin.anim"))
		...
		sndConga.SoundId = AssetGetContentId("BasicsInBehavior.mp3")
		sndConga.Volume  = 0.8
