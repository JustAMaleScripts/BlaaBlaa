-- GarryModNamebagR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/GarryModNamebagR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Garry Mod R15 Moveset"
    m.Description  = "Namebag R15 Animations"
    m.InternalName = "GarryModNamebagR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Garry Mod R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Garry Mod Idle.anim", true),
        walk = loadAnim(figure, "Garry Mod Walk.anim", true),
        jump = loadAnim(figure, "Garry Mod Jump.anim", true),
        sprint = loadAnim(figure, "Garry Mod Run.anim", true),
        }
