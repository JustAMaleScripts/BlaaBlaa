-- UhhhhhhReanim/Modules/ScoobyDooRunModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Aizo Roll"
	m.Description  = "That guy"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Yeah, this uses the conga Module", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Do you have no problem with that???", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("AizoRoll.anim"))
		...
		sndConga.SoundId = AssetGetContentId("AizoRoll.mp3")
		sndConga.Volume  = 0.8
