-- SomethingEvilWillHappenMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/SomethingEvilWillHappenMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Something Evil Will Happen"
    m.Description  = "This is the base animations from the game Something Evil Will Happen"
    m.InternalName = "SomethingEvilWillHappenMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Something Evil Will Happen", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "SEWHIdle.anim", true),
        walk = loadAnim(figure, "SEWHWalk.anim", true),
        sprint = loadAnim(figure, "SEWHRun.anim", true),
        jump = loadAnim(figure, "SEWHJump.anim", true),
        }
