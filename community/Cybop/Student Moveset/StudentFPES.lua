...
-- Place in: UhhhhhhReanim/Modules/StudentFPES.lua
...
AddModule(function()
    ...
    m.Name         = "Student"
    m.Description  = "Student Moveset From FPE:S game."
    m.InternalName = "StudentFPES"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Student", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "StudentIdle.anim", true),
        walk   = loadAnim(figure, "StudentWalk.anim", true),
        sprint   = loadAnim(figure, "StudentRun.anim", true),
        jump   = loadAnim(figure, "StudentJump.anim", true),
        }
        animJump = baseAnims.jump

        -- Attack / ability animations
        actionAnims = {
        ["Block"] = loadAnim(figure, "StudentBlock.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_Block", UDim2.new(1, -230, 1, -130))
    end
