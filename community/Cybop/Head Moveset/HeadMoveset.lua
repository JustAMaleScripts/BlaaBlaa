...
-- Place in: UhhhhhhReanim/Modules/HeadMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Head Moveset"
    m.Description  = "This is Only a Head, but is a moveset"
    m.InternalName = "HeadMoveset"
    ...
    m.Assets = {
        ...
        "JumpHead.anim",
        "RunHead.anim",
        "HeadMovesetTheme(FigmentIsTheName).mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Head Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "IdleHead.anim", true),
        walk = loadAnim(figure, "WalkHead.anim", true),
        jump = loadAnim(figure, "JumpHead.anim", true),
        sprint = loadAnim(figure, "RunHead.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("HeadMovesetTheme(FigmentIsTheName).mp3", hrp, 0.5, true)
        bgSound:Play()
        setupChat()
