-- fredyfaznosMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/fredyfaznosMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "fredy faznos"
    m.Description  = "fredy faznos from Dummysaken and Evilsaken"
    m.InternalName = "fredyfaznosMoveset"

    m.Assets = {
        "FredyFaznosIdle.anim",
        "FredyFaznosWalk.anim",
        "FredyFaznosRun.anim",
        "FredyFaznosSwing.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "fredy faznos", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "FredyFaznosIdle.anim", true),
        walk = loadAnim(figure, "FredyFaznosWalk.anim", true),
        sprint = loadAnim(figure, "FredyFaznosRun.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Swing"] = loadAnim(figure, "FredyFaznosSwing.anim", false),
        }
