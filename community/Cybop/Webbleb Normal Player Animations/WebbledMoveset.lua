...
-- Place in: UhhhhhhReanim/Modules/WebbledMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Webbled Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Webbled"
    m.InternalName = "WebbledMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Webbled Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "WebbledIdle.anim", true),
        walk = loadAnim(figure, "WebbledWalk.anim", true),
        jump = loadAnim(figure, "WebbledJump.anim", true),
        }
