-- JutjusuShenanigansMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/JutjusuShenanigansMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Jutjusu Shenanigans Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Jutjusu Shenanigans"
    m.InternalName = "JutjusuShenanigansMoveset"

    m.Assets = {
        "JujutsuShenanigansIdle.anim",
        "JujutsuShenanigansWalk.anim",
        "JujutsuShenanigansJump.anim",
        "JujutsuShenanigansRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Jutjusu Shenanigans Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "JujutsuShenanigansIdle.anim", true),
        walk = loadAnim(figure, "JujutsuShenanigansWalk.anim", true),
        jump = loadAnim(figure, "JujutsuShenanigansJump.anim", true),
        sprint = loadAnim(figure, "JujutsuShenanigansRun.anim", true),
        }
