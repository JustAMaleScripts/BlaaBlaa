-- ZombieAttackZombie.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ZombieAttackZombie.lua
...
AddModule(function()
    ...
    m.Name         = "Zombie Attack Zombie"
    m.Description  = "This moveset is the moveset of the Zombie in the game called Zombie Attack, By the way this just have ONE ANIMATION For ALL THE THINGS OF THIS IS A MOVESET RAAAAH"
    m.InternalName = "ZombieAttackZombie"

    m.Assets = {
        "ZombieAttackWalkIdleAnimation.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Zombie Attack Zombie", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "ZombieAttackWalkIdleAnimation.anim", true),
        }
