-- BunnyBunnyBunnyObbyBase.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/BunnyBunnyBunnyObbyBase.lua
...
AddModule(function()
    ...
    m.Name         = "Bunny Bunny Bunny Obby Base"
    m.Description  = "This is the base animations from the obby Bunny Bunny Bunny Obby"
    m.InternalName = "BunnyBunnyBunnyObbyBase"

    m.Assets = {
        "BunnyBunnyBunnyIdle.anim",
        "BunnyBunnyBunnyWalk.anim",
        "BunnyBunnyBunnyRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Bunny Bunny Bunny Obby Base", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "BunnyBunnyBunnyIdle.anim", true),
        walk = loadAnim(figure, "BunnyBunnyBunnyWalk.anim", true),
        sprint = loadAnim(figure, "BunnyBunnyBunnyRun.anim", true),
        }
        ...
        ContextActions:SetTitle("GM_Sprint", "Sprint")
        ContextActions:SetPosition("GM_Sprint", UDim2.new(1, -120, 1, -100))
