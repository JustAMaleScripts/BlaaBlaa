-- UhhhhhhReanim/Modules/SneakyDanceModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Sneaky Sneaky"
	m.Description  = "A very sneaky dance"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Dont provoke a sound", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Pls..", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("SneakyAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("SneakyAudioDance.mp3")
		sndConga.Volume  = 0.8
