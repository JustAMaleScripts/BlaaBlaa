-- SpringtrapR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/SpringtrapR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Springtrap R15 Moveset"
    m.Description  = "Springtrap R15 Animations"
    m.InternalName = "SpringtrapR15Moveset"

    m.Assets = {
        "Springtrap Idle.anim",
        "Springtrap Walk.anim",
        "Springtrap Jump.anim",
        "Springtrap Run.anim",
        "Springtrap Theme.mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Springtrap R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Springtrap Idle.anim", true),
        walk = loadAnim(figure, "Springtrap Walk.anim", true),
        jump = loadAnim(figure, "Springtrap Jump.anim", true),
        sprint = loadAnim(figure, "Springtrap Run.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("Springtrap Theme.mp3", hrp, 0.5, true)
        bgSound:Play()
