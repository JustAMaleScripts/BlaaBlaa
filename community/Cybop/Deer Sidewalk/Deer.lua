...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Deer Sidewalks"
	m.Description  = "Driving in My Car"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Driving", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Right after a beer", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("DeerSidewalk.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Derr.mp3")
		sndConga.Volume  = 0.8
