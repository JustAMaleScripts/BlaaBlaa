...
-- Place in: UhhhhhhReanim/Modules/DODGhostMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Die of Death Ghost Moveset"
    m.Description  = "This Moveset is based in the animations of the Ghost in the game called Die of Death"
    m.InternalName = "DODGhostMoveset"

    m.Assets = {
        "DieOfDeathGhostIdle.anim",
        "DieOfDeathGhostWalk.anim",
        "DieOfDeathGhostSprint.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Die of Death Ghost Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "DieOfDeathGhostIdle.anim", true),
        walk = loadAnim(figure, "DieOfDeathGhostWalk.anim", true),
        sprint = loadAnim(figure, "DieOfDeathGhostSprint.anim", true),
        }
