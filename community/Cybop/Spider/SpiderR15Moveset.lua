-- SpiderR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/SpiderR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Spider R15 Moveset"
    m.Description  = "Spider R15 Animations"
    m.InternalName = "SpiderR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Spider R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Spider Idle.anim", true),
        walk = loadAnim(figure, "Spider Walk.anim", true),
        jump = loadAnim(figure, "Spider Jump.anim", true),
        sprint = loadAnim(figure, "Spider Run.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("Spider Theme.mp3", hrp, 0.5, true)
        bgSound:Play()
