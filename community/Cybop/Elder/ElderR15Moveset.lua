...
-- Place in: UhhhhhhReanim/Modules/ElderR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Elder R15"
    m.Description  = "Elder Animation R15"
    m.InternalName = "ElderR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Elder R15", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Elder Idle.anim", true),
        walk = loadAnim(figure, "Elder Walk.anim", true),
        jump = loadAnim(figure, "Elder Jump.anim", true),
        sprint = loadAnim(figure, "Elder Run.anim", true),
        }
