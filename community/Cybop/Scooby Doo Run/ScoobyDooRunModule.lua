...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Scooby Doo Run"
	m.Description  = "Shaggy"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Run bro Run", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Scooby", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("ScoobyDooRun.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Scooby doo run.mp3")
		sndConga.Volume  = 0.8
