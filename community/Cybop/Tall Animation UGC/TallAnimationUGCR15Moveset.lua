-- TallAnimationUGCR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/TallAnimationUGCR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Tall Animation UGC R15 Moveset"
    m.Description  = "Tall Animation UGC R15 Animations"
    m.InternalName = "TallAnimationUGCR15Moveset"

    m.Assets = {
        "Tall Animation UGC Idle.anim",
        "Tall Animation UGC Walk.anim",
        "Tall Animation UGC Jump.anim",
        "Tall Animation UGC Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Tall Animation UGC R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Tall Animation UGC Idle.anim", true),
        walk = loadAnim(figure, "Tall Animation UGC Walk.anim", true),
        jump = loadAnim(figure, "Tall Animation UGC Jump.anim", true),
        sprint = loadAnim(figure, "Tall Animation UGC Run.anim", true),
        }
