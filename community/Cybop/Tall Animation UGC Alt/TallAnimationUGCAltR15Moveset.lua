-- TallAnimationUGCAltR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/TallAnimationUGCAltR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Tall Animation UGC Alt R15 Moveset"
    m.Description  = "Tall Animation UGC Alt R15 Animations"
    m.InternalName = "TallAnimationUGCAltR15Moveset"

    m.Assets = {
        "Tall Animation UGC Alt Idle.anim",
        "Tall Animation UGC Alt Walk.anim",
        "Tall Animation UGC Alt Jump.anim",
        "Tall Animation UGC Alt Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Tall Animation UGC Alt R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Tall Animation UGC Alt Idle.anim", true),
        walk = loadAnim(figure, "Tall Animation UGC Alt Walk.anim", true),
        jump = loadAnim(figure, "Tall Animation UGC Alt Jump.anim", true),
        sprint = loadAnim(figure, "Tall Animation UGC Alt Run.anim", true),
        }
