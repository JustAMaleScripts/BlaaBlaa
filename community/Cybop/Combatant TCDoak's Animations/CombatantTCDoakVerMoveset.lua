-- CombatantTCDoakVerMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/CombatantTCDoakVerMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Combatant TCDoak Ver Moveset"
    m.Description  = "He is a pro at this still trust me. Combatant TCDoak Ver"
    m.InternalName = "CombatantTCDoakVerMoveset"

    m.Assets = {
        "TCDoakCombatantIdle.anim",
        "TCDoakCombatantCombatantWalk.anim",
        "TCDoakCombatantRun.anim",
        "TCDoakCombatantSlash.anim",
        "TCDoakCombatantPunch.anim",
        "TCDoakCombatantKick.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Combatant TCDoak Ver Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "TCDoakCombatantIdle.anim", true),
        walk = loadAnim(figure, "TCDoakCombatantCombatantWalk.anim", true),
        sprint = loadAnim(figure, "TCDoakCombatantRun.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Slash"] = loadAnim(figure, "TCDoakCombatantSlash.anim", false),
        ["Punch"] = loadAnim(figure, "TCDoakCombatantPunch.anim", false),
        ["Kick"] = loadAnim(figure, "TCDoakCombatantKick.anim", false),
        }
        ...
        ContextActions:SetPosition("GM_Punch", UDim2.new(1, -160, 1, -110))

        ContextActions:BindAction("GM_Kick", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Kick") end
        end, true, Enum.KeyCode.C)
        ContextActions:SetTitle("GM_Kick", "Kick")
        ContextActions:SetPosition("GM_Kick", UDim2.new(1, -240, 1, -110))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_Kick")
