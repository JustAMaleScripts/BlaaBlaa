-- ClassicSpeedrunnerR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ClassicSpeedrunnerR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Classic Speedrunner R15 Moveset"
    m.Description  = "Classic Speedrunner R15 Animations"
    m.InternalName = "ClassicSpeedrunnerR15Moveset"

    m.Assets = {
        "Classic Speedrunner Idle.anim",
        "Classic Speedrunner Walk.anim",
        "Classic Speedrunner Jump.anim",
        "Classic Speedrunner Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Classic Speedrunner R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Classic Speedrunner Idle.anim", true),
        walk = loadAnim(figure, "Classic Speedrunner Walk.anim", true),
        jump = loadAnim(figure, "Classic Speedrunner Jump.anim", true),
        sprint = loadAnim(figure, "Classic Speedrunner Run.anim", true),
        }
