...
-- Place in: UhhhhhhReanim/Modules/Animatronic.lua
...
AddModule(function()
    ...
    m.Name         = "Animatronic"
    m.Description  = "Animatronic from fnaf"
    m.InternalName = "Animatronic"

    -- ── ASSETS ────────────────────────────────────────────────────────────
    m.Assets = {
        "IdleAnimatronic.anim",
        "WalkAnimatronic.anim",
        "RunAnimatronic.anim",
        "PerfomanceAnimatronic.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Animatronic", 18, Enum.TextXAlignment.Center)
        Util_CreateSeparator(parent)
        Util_CreateText(parent, "Fling on Hit", 15, Enum.TextXAlignment.Center)
        Util_CreateSwitch(parent, "Perfomance flings", m.FlingEnabled["Perfomance"]).Changed:Connect(function(v) m.FlingEnabled["Perfomance"] = v end)
    end
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "IdleAnimatronic.anim", true),
        walk   = loadAnim(figure, "WalkAnimatronic.anim", true),
        sprint   = loadAnim(figure, "RunAnimatronic.anim", true),
        }
        animJump = baseAnims.jump

        -- Attack / ability animations
        actionAnims = {
        ["Perfomance"] = loadAnim(figure, "PerfomanceAnimatronic.anim", false),
        }
        ...
        ContextActions:BindAction("GM_Perfomance", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Perfomance") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Perfomance", "Perfomance")
        ContextActions:SetPosition("GM_Perfomance", UDim2.new(1, -230, 1, -130))
    end
    ...
    m.Destroy = function()
        ...
        ContextActions:UnbindAction("GM_Perfomance")
