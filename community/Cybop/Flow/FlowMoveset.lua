...
-- Place in: UhhhhhhReanim/Modules/FlowMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Flow Moveset"
    m.Description  = "This Moveset is based in the animations player of the game called Flow"
    m.InternalName = "FlowMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Flow Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "FLowIdle.anim", true),
        walk = loadAnim(figure, "FLowWalk.anim", true),
        sprint = loadAnim(figure, "FLowRun.anim", true),
        }
