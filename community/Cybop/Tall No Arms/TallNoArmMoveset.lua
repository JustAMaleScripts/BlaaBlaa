-- TallNoArmMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/TallNoArmMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Tall No Arm"
    m.Description  = "You Are Tall!, But no arms"
    m.InternalName = "TallNoArmMoveset"

    m.Assets = {
        "Tall No Arm Idle.anim",
        "Tall  No Arm Walk.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Tall No Arm", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Tall No Arm Idle.anim", true),
        walk = loadAnim(figure, "Tall  No Arm Walk.anim", true),
        }
