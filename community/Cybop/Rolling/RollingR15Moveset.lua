-- RollingR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/RollingR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Rolling R15 Moveset"
    m.Description  = "Rolling R15 Animations"
    m.InternalName = "RollingR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Rolling R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Rolling Idle.anim", true),
        walk = loadAnim(figure, "Rolling Walk.anim", true),
        jump = loadAnim(figure, "Rolling Jump.anim", true),
        sprint = loadAnim(figure, "Rolling Run.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("Rolling Theme.mp3", hrp, 0.5, true)
        bgSound:Play()
