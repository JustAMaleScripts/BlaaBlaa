-- DarkR6DanceMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/DarkR6DanceMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Dark R6 Dance Moveset"
    m.Description  = "This is the base animations from the game called Dark R6 Dance"
    m.InternalName = "DarkR6DanceMoveset"

    m.Assets = {
        "DarkR6DanceIdle.anim",
        "DarkR6DanceWalk.anim",
        "DarkR6DanceRun.anim",
        "DarkR6DanceJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Dark R6 Dance Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "DarkR6DanceIdle.anim", true),
        walk = loadAnim(figure, "DarkR6DanceWalk.anim", true),
        sprint = loadAnim(figure, "DarkR6DanceRun.anim", true),
        jump = loadAnim(figure, "DarkR6DanceJump.anim", true),
        }
