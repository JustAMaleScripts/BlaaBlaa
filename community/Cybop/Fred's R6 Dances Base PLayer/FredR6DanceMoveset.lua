-- FredR6DanceMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/FredR6DanceMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Fred R6 Dance"
    m.Description  = "This is the base animations from the game Fred R6 Dance"
    m.InternalName = "FredR6DanceMoveset"

    m.Assets = {
        "FredR6DanceIdle.anim",
        "FredR6DanceWalk.anim",
        "FredR6DanceRun.anim",
        "FredR6DanceJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Fred R6 Dance", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "FredR6DanceIdle.anim", true),
        walk = loadAnim(figure, "FredR6DanceWalk.anim", true),
        sprint = loadAnim(figure, "FredR6DanceRun.anim", true),
        jump = loadAnim(figure, "FredR6DanceJump.anim", true),
        }
