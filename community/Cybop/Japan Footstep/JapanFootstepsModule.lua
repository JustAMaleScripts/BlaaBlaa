-- UhhhhhhReanim/Modules/JapanFootstepsModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Japan Footsteps"
	m.Description  = "Person in Japan when no electricy (dead meme, idk)"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Don't Get Killed Again!", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Failure..", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("JapanFootstep.anim"))
		...
		sndConga.SoundId = AssetGetContentId("JapanFootstepsAudio.mp3")
		sndConga.Volume  = 0.8
