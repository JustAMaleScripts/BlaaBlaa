-- WerewolfR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/WerewolfR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Werewolf R15 Moveset"
    m.Description  = "Werewolf R15 Animations"
    m.InternalName = "WerewolfR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Werewolf R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "WerewolfIdle.anim", true),
        walk = loadAnim(figure, "WerewolfWalk.anim", true),
        jump = loadAnim(figure, "WerewolfJump.anim", true),
        sprint = loadAnim(figure, "WerewolfRun.anim", true),
        }
