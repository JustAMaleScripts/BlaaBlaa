...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Abbie Run"
	m.Description  = "Run Run Apple Boy!"
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Abbie Run.anim"))
		...
		sndConga.SoundId = AssetGetContentId("MissCircleAbbieRun.mp3")
		sndConga.Volume  = 0.8
