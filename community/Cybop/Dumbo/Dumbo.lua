...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Dumbo"
	m.Description  = "Rat (This was used based on the conga dance)"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "DUMBO!", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "DUMBO IS SILLY, What", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Dumbo.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Dumbi.mp3")
		sndConga.Volume  = 0.8
