...
-- Place in: UhhhhhhReanim/Modules/TallR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Tall r15 Moveset"
    m.Description  = "You Are Tall!"
    m.InternalName = "TallR15Moveset"

    m.Assets = {
        "Tall R15 To R6 Idle.anim",
        "Tall R15 To R6 Walk.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Tall r15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Tall R15 To R6 Idle.anim", true),
        walk = loadAnim(figure, "Tall R15 To R6 Walk.anim", true),
        }
