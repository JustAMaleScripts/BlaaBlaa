...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Brainz"
	m.Description  = "ZOMBIE TSUNAMI REFERENCE"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Eat Brainz ", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Just eat", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("ZombieTsunami.anim"))
		...
		sndConga.SoundId = AssetGetContentId("ZombieOsT.mp3")
		sndConga.Volume  = 0.8
