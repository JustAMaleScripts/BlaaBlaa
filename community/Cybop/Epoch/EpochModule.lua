-- UhhhhhhReanim/Modules/Epoch.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Epoch"
	m.Description  = "Flower"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Flower", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "You feel guilty...", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Epoch.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Epoch.mp3")
		sndConga.Volume  = 0.8
