-- AstronautMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/AstronautMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Astronaut R15"
    m.Description  = "Astronaut Animation R15"
    m.InternalName = "AstronautMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Astronaut R15", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "AstronautIdle.anim", true),
        walk = loadAnim(figure, "AstronautWalk.anim", true),
        jump = loadAnim(figure, "AstronautJump.anim", true),
        sprint = loadAnim(figure, "AstronautRun.anim", true),
        }
