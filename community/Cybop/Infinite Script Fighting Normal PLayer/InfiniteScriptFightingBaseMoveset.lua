-- InfiniteScriptFightingBaseMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/InfiniteScriptFightingBaseMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Infinite Script Fighting Base"
    m.Description  = "This is the base animations in Infinite Script Fighting"
    m.InternalName = "InfiniteScriptFightingBaseMoveset"

    m.Assets = {
        "InfiniteScriptFightIdle.anim",
        "InfiniteScriptFightRun.anim",
        "InfiniteScriptFightJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Infinite Script Fighting Base", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "InfiniteScriptFightIdle.anim", true),
        walk = loadAnim(figure, "InfiniteScriptFightRun.anim", true),
        jump = loadAnim(figure, "InfiniteScriptFightJump.anim", true),
        }
