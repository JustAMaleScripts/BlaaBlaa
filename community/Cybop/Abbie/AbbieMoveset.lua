...
-- Place in: UhhhhhhReanim/Modules/AbbieMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Abbie Moveset"
    m.Description  = "A shy boy apple who gets bullied a lot"
    m.InternalName = "AbbieMoveset"

    m.Assets = {
        "Abbie Idle.anim",
        "Abbie Walk.anim",
        "AbbieRunDummysaken.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Abbie Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Abbie Idle.anim", true),
        walk = loadAnim(figure, "Abbie Walk.anim", true),
        sprint = loadAnim(figure, "AbbieRunDummysaken.anim", true),
        }
