-- WeepingAngelR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/WeepingAngelR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Weeping Angel R15 Moveset"
    m.Description  = "Weeping Angel R15 Animations"
    m.InternalName = "WeepingAngelR15Moveset"

    m.Assets = {
        "Weeping Angel Idle.anim",
        "Weeping Angel Walk.anim",
        "Weeping Angel Jump.anim",
        "Weeping Angel Run.anim",
        "Weeping Angel Theme.mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Weeping Angel R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Weeping Angel Idle.anim", true),
        walk = loadAnim(figure, "Weeping Angel Walk.anim", true),
        jump = loadAnim(figure, "Weeping Angel Jump.anim", true),
        sprint = loadAnim(figure, "Weeping Angel Run.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("Weeping Angel Theme.mp3", hrp, 0.5, true)
        bgSound:Play()
