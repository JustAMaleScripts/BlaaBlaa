...
-- Place in: UhhhhhhReanim/Modules/ToyR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Toy R15 Moveset"
    m.Description  = "Toy R15 Animations"
    m.InternalName = "ToyR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Toy R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "ToyIdle.anim", true),
        walk = loadAnim(figure, "ToyWalk.anim", true),
        jump = loadAnim(figure, "ToyJump.anim", true),
        sprint = loadAnim(figure, "ToyRun.anim", true),
        }
