-- CuteBouncyMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/CuteBouncyMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Cute Bouncy R15"
    m.Description  = "Cute Bouncy Animation R15"
    m.InternalName = "CuteBouncyMoveset"

    m.Assets = {
        "Cute Bouncy Idle.anim",
        "Cute Bouncy Walk.anim",
        "Cute Bouncy Jump.anim",
        "Cute Bouncy Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Cute Bouncy R15", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Cute Bouncy Idle.anim", true),
        walk = loadAnim(figure, "Cute Bouncy Walk.anim", true),
        jump = loadAnim(figure, "Cute Bouncy Jump.anim", true),
        sprint = loadAnim(figure, "Cute Bouncy Run.anim", true),
        }
