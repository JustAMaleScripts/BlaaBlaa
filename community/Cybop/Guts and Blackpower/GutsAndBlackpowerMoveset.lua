-- GutsAndBlackpowerMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/GutsAndBlackpowerMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Guts and Blackpower Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Guts and Blackpower"
    m.InternalName = "GutsAndBlackpowerMoveset"

    m.Assets = {
        "GutsAndBlackpowerIdle.anim",
        "GutsAndBlackpowerWalk.anim",
        "GutsAndBlackpowerJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Guts and Blackpower Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "GutsAndBlackpowerIdle.anim", true),
        walk = loadAnim(figure, "GutsAndBlackpowerWalk.anim", true),
        jump = loadAnim(figure, "GutsAndBlackpowerJump.anim", true),
        }
