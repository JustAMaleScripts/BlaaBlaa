-- CombatantMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/CombatantMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Combatant Moveset"
    m.Description  = "He is a pro at this still trust me"
    m.InternalName = "CombatantMoveset"

    m.Assets = {
        "Combatant Idle.anim",
        "Combatant Walk.anim",
        "Combatant Run.anim",
        "Combatant Slash.anim",
        "CombatantPunch.anim",
        "Combatant Kick.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Combatant Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Combatant Idle.anim", true),
        walk = loadAnim(figure, "Combatant Walk.anim", true),
        sprint = loadAnim(figure, "Combatant Run.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Slash"] = loadAnim(figure, "Combatant Slash.anim", false),
        ["Punch"] = loadAnim(figure, "CombatantPunch.anim", false),
        ["Kick"] = loadAnim(figure, "Combatant Kick.anim", false),
        }
