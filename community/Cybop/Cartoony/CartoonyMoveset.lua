...
-- Place in: UhhhhhhReanim/Modules/CartoonyMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Cartoony R15"
    m.Description  = "Cartoony Animation R15"
    m.InternalName = "CartoonyMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Cartoony R15", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "CartoonyIdle.anim", true),
        walk = loadAnim(figure, "CartoonyWalk.anim", true),
        jump = loadAnim(figure, "CartoonyJump.anim", true),
        sprint = loadAnim(figure, "CartoonyRun.anim", true),
        }
