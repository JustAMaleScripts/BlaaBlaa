...
-- Place in: UhhhhhhReanim/Modules/CrawlR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Crawl R15 Moveset"
    m.Description  = "Crawl R15 Animations"
    m.InternalName = "CrawlR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Crawl R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Crawl Idle.anim", true),
        walk = loadAnim(figure, "Crawl Walk.anim", true),
        jump = loadAnim(figure, "Crawl Jump.anim", true),
        sprint = loadAnim(figure, "Crawl Run.anim", true),
        }
