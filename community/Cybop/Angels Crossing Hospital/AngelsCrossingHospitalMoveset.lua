-- AngelsCrossingHospitalMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/AngelsCrossingHospitalMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Angels Crossing Hospital Moveset"
    m.Description  = "This Moveset is based in the animations of the game called Angels Crossing Hospital"
    m.InternalName = "AngelsCrossingHospitalMoveset"

    m.Assets = {
        "AngelsCrossingHospitalIdle.anim",
        "AngelsCrossingHospitalWalk.anim",
        "AngelsCrossingHospitalJump.anim",
        "AngelsCrossingHospitalRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Angels Crossing Hospital Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "AngelsCrossingHospitalIdle.anim", true),
        walk = loadAnim(figure, "AngelsCrossingHospitalWalk.anim", true),
        jump = loadAnim(figure, "AngelsCrossingHospitalJump.anim", true),
        sprint = loadAnim(figure, "AngelsCrossingHospitalRun.anim", true),
        }
        ...
        ContextActions:SetTitle("GM_Sprint", "Sprint")
        ContextActions:SetPosition("GM_Sprint", UDim2.new(1, -60, 1, -130))
