...
-- Place in: UhhhhhhReanim/Modules/ShyR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Shy R15 Moveset"
    m.Description  = "Shy R15 Animations"
    m.InternalName = "ShyR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Shy R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Shy Idle.anim", true),
        walk = loadAnim(figure, "Shy Walk.anim", true),
        jump = loadAnim(figure, "Shy Jump.anim", true),
        sprint = loadAnim(figure, "Shy Run.anim", true),
        }
