...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Sonic Dash"
	m.Description  = "FAST FAST FAST"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "FAST!", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "FAST FAST FAST", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Sonic Dash.anim"))
		...
		sndConga.SoundId = AssetGetContentId("breakcore.mp3")
		sndConga.Volume  = 0.8
