-- EmoteBlendMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/EmoteBlendMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Emote.blend Moveset"
    m.Description  = "This Moveset is based in the animations player of the game called Emote.blend"
    m.InternalName = "EmoteBlendMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Emote.blend Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Emoteblenidle.anim", true),
        walk = loadAnim(figure, "EmoteblenWalk.anim", true),
        jump = loadAnim(figure, "EmoteblenJump.anim", true),
        }
