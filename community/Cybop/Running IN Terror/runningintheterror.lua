...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Running In Terror"
	m.Description  = "Run bro"
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("runningInTerror.anim"))
		...
		sndConga.SoundId = AssetGetContentId("500MILLES.mp3")
		sndConga.Volume  = 0.8
