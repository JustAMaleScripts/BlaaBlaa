-- SquishyR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/SquishyR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Squishy R15 Moveset"
    m.Description  = "Squishy R15 Animations"
    m.InternalName = "SquishyR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Squishy R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Squishy Idle.anim", true),
        walk = loadAnim(figure, "Squishy Walk.anim", true),
        jump = loadAnim(figure, "Squishy Jump.anim", true),
        sprint = loadAnim(figure, "Squishy Run.anim", true),
        }
