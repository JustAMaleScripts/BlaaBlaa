-- UhhhhhhReanim/Modules/TuckerModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Tucker"
	m.Description  = "Tucker SlON dance"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "So slow!", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "son..", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("TuckerAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("TuckerAudio.mp3")
		sndConga.Volume  = 0.8
