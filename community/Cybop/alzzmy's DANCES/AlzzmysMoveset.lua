...
-- Place in: UhhhhhhReanim/Modules/AlzzmysMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Alzzmys Dance Moveset"
    m.Description  = "This Moveset is based in the animations of the game called Alzzmys Dance"
    m.InternalName = "AlzzmysMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Alzzmys Dance Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "AlzzmyIdle.anim", true),
        walk = loadAnim(figure, "AlzzmyWalk.anim", true),
        jump = loadAnim(figure, "AlzzmyJump.anim", true),
        sprint = loadAnim(figure, "AlzzmyRun.anim", true),
        }
