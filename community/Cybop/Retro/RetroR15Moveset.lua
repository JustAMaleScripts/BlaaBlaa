...
-- Place in: UhhhhhhReanim/Modules/RetroR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Retro R15 Moveset"
    m.Description  = "Retro R15 Animations"
    m.InternalName = "RetroR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Retro R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Retro Idle.anim", true),
        walk = loadAnim(figure, "Retro Walk.anim", true),
        jump = loadAnim(figure, "Retro Jump.anim", true),
        sprint = loadAnim(figure, "Retro Run.anim", true),
        }
