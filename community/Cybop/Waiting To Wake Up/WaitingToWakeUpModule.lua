-- UhhhhhhReanim/Modules/WaitingToWakeUpModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Waiting To Wake Up"
	m.Description  = "Waiting... This is a Walkie Dance"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Wait...", 24, Enum.TextXAlignment.Center)
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("WaitingToWakeUp.anim"))
		...
		sndConga.SoundId = AssetGetContentId("WaitingToWakeUpSound.mp3")
		sndConga.Volume  = 0.8
