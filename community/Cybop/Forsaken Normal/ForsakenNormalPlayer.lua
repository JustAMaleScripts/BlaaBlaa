-- ForsakenNormalPlayer.lua
-- Generated by Reanim Moveset Creator v5
-- Place in: UhhhhhhReanim/Modules/ForsakenNormalPlayer.lua
...
AddModule(function()
    ...
    m.Name         = "Forsaken Normal Moveset"
    m.Description  = "This is the normal player animations."
    m.InternalName = "ForsakenNormalPlayer"

    -- ── ASSETS ────────────────────────────────────────────────────────────
    m.Assets = {
        "ForsakenNormalIdle.anim",
        "ForsakenNormalWalk.anim",
        "ForsakenNormalRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Forsaken Normal Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "ForsakenNormalIdle.anim", true),
        walk   = loadAnim(figure, "ForsakenNormalWalk.anim", true),
        sprint   = loadAnim(figure, "ForsakenNormalRun.anim", true),
        }
