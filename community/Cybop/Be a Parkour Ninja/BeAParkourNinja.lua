...
-- Place in: UhhhhhhReanim/Modules/BeAParkourNinja.lua
...
AddModule(function()
    ...
    m.Name         = "Be a Parkour Ninja"
    m.Description  = "This is a moveset about the base animations of the game Be a Parkour Ninja, nothing else."
    m.InternalName = "BeAParkourNinja"

    m.Assets = {
        "BeAParkourNinjaIdle.anim",
        "BeAParkourNinjaWALKRUN.anim",
        "BeAParkourNinjaFall.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Be a Parkour Ninja", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "BeAParkourNinjaIdle.anim", true),
        walk = loadAnim(figure, "BeAParkourNinjaWALKRUN.anim", true),
        jump = loadAnim(figure, "BeAParkourNinjaFall.anim", true),
        }
