-- TheStrongestBattlegroundsMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/TheStrongestBattlegroundsMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "The Strongest Battlegrounds Moveset"
    m.Description  = "This Moveset is based in the animations player of the game The Strongest Battlegrounds"
    m.InternalName = "TheStrongestBattlegroundsMoveset"

    m.Assets = {
        "TheStrongestBattlegroundsIdle.anim",
        "TheStrongestBattlegroundsWalk.anim",
        "TheStrongestBattlegroundsJump.anim",
        "TheStrongestBattlegroundsRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "The Strongest Battlegrounds Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "TheStrongestBattlegroundsIdle.anim", true),
        walk = loadAnim(figure, "TheStrongestBattlegroundsWalk.anim", true),
        jump = loadAnim(figure, "TheStrongestBattlegroundsJump.anim", true),
        sprint = loadAnim(figure, "TheStrongestBattlegroundsRun.anim", true),
        }
        ...
        ContextActions:SetTitle("GM_Sprint", "Sprint")
        ContextActions:SetPosition("GM_Sprint", UDim2.new(1, -100, 1, -130))
