...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Snail"
	m.Description  = "Shape into a snail"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "snail Run", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "wait no, You a're slow", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("SnailAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("Claire de Lune.mp3")
		sndConga.Volume  = 0.8
