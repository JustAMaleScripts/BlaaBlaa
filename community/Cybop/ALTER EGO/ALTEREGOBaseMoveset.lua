-- ALTEREGOBaseMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ALTEREGOBaseMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "ALTER EGO Base"
    m.Description  = "This is the base animations from ALTER EGO"
    m.InternalName = "ALTEREGOBaseMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "ALTER EGO Base", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "AlterEgoIdle.anim", true),
        walk = loadAnim(figure, "AlterEgoWalk.anim", true),
        sprint = loadAnim(figure, "AlterEgoRun.anim", true),
        }
