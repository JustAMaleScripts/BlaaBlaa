-- RoaringKnightR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/RoaringKnightR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Roaring Knight R15 Moveset"
    m.Description  = "Roaring Knight R15 Animations"
    m.InternalName = "RoaringKnightR15Moveset"

    m.Assets = {
        "Roaring Knight Idle.anim",
        "Roaring Knight Walk.anim",
        "Roaring Knight Jump.anim",
        "Roaring Knight Run.anim",
        "RoaringKnightThemeBlackKnife.mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Roaring Knight R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Roaring Knight Idle.anim", true),
        walk = loadAnim(figure, "Roaring Knight Walk.anim", true),
        jump = loadAnim(figure, "Roaring Knight Jump.anim", true),
        sprint = loadAnim(figure, "Roaring Knight Run.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("RoaringKnightThemeBlackKnife.mp3", hrp, 0.5, true)
        bgSound:Play()
