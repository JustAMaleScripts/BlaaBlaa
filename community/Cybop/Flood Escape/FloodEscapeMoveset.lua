-- FloodEscapeMoveset.lua
-- Generated by Reanim Moveset Creator v5
-- Place in: UhhhhhhReanim/Modules/FloodEscapeMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Flood Escape Moveset"
    m.Description  = "Flood Escape Animations, Is from the community game."
    m.InternalName = "FloodEscapeMoveset"

    -- ── ASSETS ────────────────────────────────────────────────────────────
    m.Assets = {
        "FloodEscapeIdle.anim",
        "FloodEscapeWalk.anim",
        "FloodEscapeJump.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Flood Escape Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "FloodEscapeIdle.anim", true),
        walk   = loadAnim(figure, "FloodEscapeWalk.anim", true),
        jump   = loadAnim(figure, "FloodEscapeJump.anim", true),
        }
