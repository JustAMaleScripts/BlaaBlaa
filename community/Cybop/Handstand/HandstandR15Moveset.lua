-- HandstandR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/HandstandR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Handstand R15 Moveset"
    m.Description  = "Handstand R15 Animations"
    m.InternalName = "HandstandR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Handstand R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Handstand Idle.anim", true),
        walk = loadAnim(figure, "Handstand Walk.anim", true),
        jump = loadAnim(figure, "Handstand Jump.anim", true),
        sprint = loadAnim(figure, "Handstand Run.anim", true),
        }
