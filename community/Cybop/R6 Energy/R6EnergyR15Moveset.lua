-- R6EnergyR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/R6EnergyR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "R6 Energy R15 Moveset"
    m.Description  = "R6 Energy R15 Animations"
    m.InternalName = "R6EnergyR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "R6 Energy R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "R6 Energy Idle.anim", true),
        walk = loadAnim(figure, "R6 Energy Walk.anim", true),
        jump = loadAnim(figure, "R6 Energy Jump.anim", true),
        sprint = loadAnim(figure, "R6 Energy Run.anim", true),
        }
