-- R15DefaultMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/R15DefaultMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "R15 Default Animations"
    m.Description  = "Normal Animation R15"
    m.InternalName = "R15DefaultMoveset"

    m.Assets = {
        "R15 Default Idle.anim",
        "R15 Default Walk.anim",
        "R15 Default Jump.anim",
        "R15 Default Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "R15 Default Animations", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "R15 Default Idle.anim", true),
        walk = loadAnim(figure, "R15 Default Walk.anim", true),
        jump = loadAnim(figure, "R15 Default Jump.anim", true),
        sprint = loadAnim(figure, "R15 Default Run.anim", true),
        }
