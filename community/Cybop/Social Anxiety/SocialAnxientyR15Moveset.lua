-- SocialAnxientyR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/SocialAnxientyR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Social Anxienty R15 Moveset"
    m.Description  = "Social Anxienty R15 Animations"
    m.InternalName = "SocialAnxientyR15Moveset"

    m.Assets = {
        "Social Anxiety Idle.anim",
        "Social Anxiety Walk.anim",
        "Social Anxiety Jump.anim",
        "Social Anxiety Run.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Social Anxienty R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Social Anxiety Idle.anim", true),
        walk = loadAnim(figure, "Social Anxiety Walk.anim", true),
        jump = loadAnim(figure, "Social Anxiety Jump.anim", true),
        sprint = loadAnim(figure, "Social Anxiety Run.anim", true),
        }
