-- UntitledGubbyGameMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/UntitledGubbyGameMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Untitled Gubby Game Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Untitled Gubby Game"
    m.InternalName = "UntitledGubbyGameMoveset"

    m.Assets = {
        "UntitledGubbyGameIdle.anim",
        "UntitledGubbyGameWalk.anim",
        "UntitledGubbyGameJump.anim",
        "UntitledGubbyGameRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Untitled Gubby Game Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "UntitledGubbyGameIdle.anim", true),
        walk = loadAnim(figure, "UntitledGubbyGameWalk.anim", true),
        jump = loadAnim(figure, "UntitledGubbyGameJump.anim", true),
        sprint = loadAnim(figure, "UntitledGubbyGameRun.anim", true),
        }
