-- FriendBroMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/FriendBroMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "FriendBro"
    m.Description  = "Pursuer friend"
    m.InternalName = "FriendBroMoveset"

    m.Assets = {
        "FriendBroIdle.anim",
        "FriendBroWalk.anim",
        "FriendBroSprint.anim",
        "FriendBroAttack.anim",
        "FriendBroLunge.anim",
        "FriendBroStun.anim",
        "FriendBroIntro.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "FriendBro", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "FriendBroIdle.anim", true),
        walk = loadAnim(figure, "FriendBroWalk.anim", true),
        sprint = loadAnim(figure, "FriendBroSprint.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Swing"] = loadAnim(figure, "FriendBroAttack.anim", false),
        ["Lunge"] = loadAnim(figure, "FriendBroLunge.anim", false),
        ["Stunt"] = loadAnim(figure, "FriendBroStun.anim", false),
        ["Intro"] = loadAnim(figure, "FriendBroIntro.anim", false),
        }
        ...
        ContextActions:SetTitle("GM_Sprint", "Sprint")
        ContextActions:SetPosition("GM_Sprint", UDim2.new(1, -110, 1, -100))
        ...
        ContextActions:SetPosition("GM_Swing", UDim2.new(1, -160, 1, -100))
        ...
        ContextActions:SetPosition("GM_Lunge", UDim2.new(1, -210, 1, -100))
        ...
        ContextActions:SetPosition("GM_Stunt", UDim2.new(1, -110, 1, -140))
        ...
        ContextActions:SetPosition("GM_Intro", UDim2.new(1, -160, 1, -140))
    end
