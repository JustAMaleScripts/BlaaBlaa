...
-- Place in: UhhhhhhReanim/Modules/ChibiMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Chibi Moveset"
    m.Description  = "Tiny guy"
    m.InternalName = "ChibiMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Chibi Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Chibi Idle.anim", true),
        walk = loadAnim(figure, "Chibi Walk.anim", true),
        }
