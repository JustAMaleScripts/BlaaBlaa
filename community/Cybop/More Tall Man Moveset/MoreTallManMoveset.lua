-- MoreTallManMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/MoreTallManMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "More Tall Man"
    m.Description  = "This a MORE tall man Moveset"
    m.InternalName = "MoreTallManMoveset"

    m.Assets = {
        "MoreTallManIdle.anim",
        "MoreTallManWalk.anim",
        "MoreTallManRunning.anim",
        "MoreTallManTheme(BarracksSettlement).mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "More Tall Man", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "MoreTallManIdle.anim", true),
        walk = loadAnim(figure, "MoreTallManWalk.anim", true),
        sprint = loadAnim(figure, "MoreTallManRunning.anim", true),
        }
        animJump = baseAnims.jump

        bgSound = makeSound("MoreTallManTheme(BarracksSettlement).mp3", hrp, 0.5, true)
        bgSound:Play()
        ...
        ContextActions:SetTitle("GM_Sprint", "Sprint")
        ContextActions:SetPosition("GM_Sprint", UDim2.new(1, -70, 1, -130))
