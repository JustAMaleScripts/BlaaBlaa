-- MidnightsHorrorsMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/MidnightsHorrorsMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Midnights Horrors Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Midnights Horrors"
    m.InternalName = "MidnightsHorrorsMoveset"

    m.Assets = {
        "MidnightsHorrorsIdle.anim",
        "MidnightsHorrorsWalk.anim",
        "MidnightsHorrorsJump.anim",
        "MidnightsHorrorsRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Midnights Horrors Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "MidnightsHorrorsIdle.anim", true),
        walk = loadAnim(figure, "MidnightsHorrorsWalk.anim", true),
        jump = loadAnim(figure, "MidnightsHorrorsJump.anim", true),
        sprint = loadAnim(figure, "MidnightsHorrorsRun.anim", true),
        }
