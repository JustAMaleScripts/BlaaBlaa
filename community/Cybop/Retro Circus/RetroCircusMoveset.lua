-- RetroCircusMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/RetroCircusMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Retro Circus Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Retro Circus"
    m.InternalName = "RetroCircusMoveset"

    m.Assets = {
        "RetroCircusIdle.anim",
        "RetroCircusWalk.anim",
        "RetroCircusJump.anim",
        "RetroCircusRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Retro Circus Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "RetroCircusIdle.anim", true),
        walk = loadAnim(figure, "RetroCircusWalk.anim", true),
        jump = loadAnim(figure, "RetroCircusJump.anim", true),
        sprint = loadAnim(figure, "RetroCircusRun.anim", true),
        }
