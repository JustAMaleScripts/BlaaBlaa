-- Doll30R15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/Doll30R15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Doll 3-0 R15 Moveset"
    m.Description  = "Doll 3-0 R15 Animations"
    m.InternalName = "Doll30R15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Doll 3-0 R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Doll 3-0 Idle.anim", true),
        walk = loadAnim(figure, "Doll 3-0 Walk.anim", true),
        jump = loadAnim(figure, "Doll 3-0 Jump.anim", true),
        sprint = loadAnim(figure, "Doll 3-0 Run.anim", true),
        }
