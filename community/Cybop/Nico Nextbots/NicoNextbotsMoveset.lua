-- NicoNextbotsMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/NicoNextbotsMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Nico Nextbots Moveset"
    m.Description  = "This Moveset is based in the animations player of the game Nico Nextbots"
    m.InternalName = "NicoNextbotsMoveset"

    m.Assets = {
        "NicoNextbotsIdle.anim",
        "NicoNextbotsWalk.anim",
        "NicoNextbotsJump.anim",
        "NicoNextbotsRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Nico Nextbots Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "NicoNextbotsIdle.anim", true),
        walk = loadAnim(figure, "NicoNextbotsWalk.anim", true),
        jump = loadAnim(figure, "NicoNextbotsJump.anim", true),
        sprint = loadAnim(figure, "NicoNextbotsRun.anim", true),
        }
