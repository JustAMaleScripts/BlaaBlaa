-- ScreamJamBaseMoveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ScreamJamBaseMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Scream Jam Base"
    m.Description  = "This is the base animations from the game Scream Jam"
    m.InternalName = "ScreamJamBaseMoveset"

    m.Assets = {
        "ScreamJamBaseIdle.anim",
        "ScreamJamBaseWalk.anim",
        "ScreamJamBaseRun.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Scream Jam Base", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "ScreamJamBaseIdle.anim", true),
        walk = loadAnim(figure, "ScreamJamBaseWalk.anim", true),
        sprint = loadAnim(figure, "ScreamJamBaseRun.anim", true),
        }
