...
-- Place in: UhhhhhhReanim/Modules/LuigineMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Luiguine Moveset"
    m.Description  = "He is Marcus younger brother."
    m.InternalName = "LuigineMoveset"

    m.Assets = {
        "LuiguineIdle.anim",
        "Luiguinewalking.anim",
        "LuiguineRunning.anim",
        "LuiguineZoomPunch.anim",
        "LuiguineFireball.anim",
        "LuiguineCounter.anim",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Luiguine Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "LuiguineIdle.anim", true),
        walk = loadAnim(figure, "Luiguinewalking.anim", true),
        sprint = loadAnim(figure, "LuiguineRunning.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Zoom Punch"] = loadAnim(figure, "LuiguineZoomPunch.anim", false),
        ["Fireball"] = loadAnim(figure, "LuiguineFireball.anim", false),
        ["Counter"] = loadAnim(figure, "LuiguineCounter.anim", false),
        }
        ...
        ContextActions:BindAction("GM_Zoom_Punch", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Zoom Punch") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Zoom_Punch", "Zoom Punch")
        ContextActions:SetPosition("GM_Zoom_Punch", UDim2.new(1, -200, 1, -110))
        ...
        ContextActions:SetPosition("GM_Fireball", UDim2.new(1, -160, 1, -110))

        ContextActions:BindAction("GM_Counter", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Counter") end
        end, true, Enum.KeyCode.C)
        ContextActions:SetTitle("GM_Counter", "Counter")
        ContextActions:SetPosition("GM_Counter", UDim2.new(1, -240, 1, -110))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_Zoom_Punch")
        ContextActions:UnbindAction("GM_Fireball")
        ContextActions:UnbindAction("GM_Counter")
