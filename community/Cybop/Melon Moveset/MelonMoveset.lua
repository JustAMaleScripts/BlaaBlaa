...
-- Place in: UhhhhhhReanim/Modules/MelonMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "Melon Moveset"
    m.Description  = "My own Character Moveset"
    m.InternalName = "MelonMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Melon Moveset", 18, Enum.TextXAlignment.Center)
    ...
    local animSnd_MelonWalk_anim = nil
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle   = loadAnim(figure, "MelonIdle.anim", true),
        walk   = loadAnim(figure, "MelonWalk.anim", true),
        sprint   = loadAnim(figure, "MelonRun.anim", true),
        }
        animJump = baseAnims.jump

        -- Attack / ability animations
        actionAnims = {
        ["Attack"] = loadAnim(figure, "MelonAttack.anim", false),
        }


        -- Init per-animation audio
    animSnd_MelonWalk_anim = makeSound("Melon8bitWalk.mp3", hrp, 0.7, false)
    ...
    if animSnd_MelonWalk_anim then animSnd_MelonWalk_anim:Stop() animSnd_MelonWalk_anim:Destroy() animSnd_MelonWalk_anim = nil end
