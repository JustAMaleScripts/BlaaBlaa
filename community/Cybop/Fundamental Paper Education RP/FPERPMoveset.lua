...
-- Place in: UhhhhhhReanim/Modules/FPERPMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "FPE RP Moveset"
    m.Description  = "This Moveset is based in the animations player of the game FPE RP"
    m.InternalName = "FPERPMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "FPE RP Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "FPERPIdle.anim", true),
        walk = loadAnim(figure, "FPERPWalk.anim", true),
        sprint = loadAnim(figure, "FPERPRun.anim", true),
        jump = loadAnim(figure, "FPERPJump.anim", true),
        }
