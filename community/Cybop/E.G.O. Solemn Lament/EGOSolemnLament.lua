...
-- Place in: UhhhhhhReanim/Modules/EGOSolemnLament.lua
...
AddModule(function()
    ...
    m.Name         = "EGO Solemn Lament"
    m.Description  = "E.G.O. Solemn Lament, Where does one go when they die?"
    m.InternalName = "EGOSolemnLament"

    m.Assets = {
        "SolemnLamentIdle.anim",
        "SolemnLamentWalk.anim",
        "SolemnLamentRun.anim",
        "Solemnlamentfire1.anim",
        "solemnlamentFire2.anim",
        "solemnlamentFire3.anim",
        "SolemnLamentStunt.anim",
        "SolemnLamentTheme.mp3",
        "SolemnLamentfire1sound.mp3",
        "SolemnLamentfire2sound.mp3",
    }
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "EGO Solemn Lament", 18, Enum.TextXAlignment.Center)
    ...
    local snd_Fire_1 = nil
    local snd_Fire_2 = nil
    ...
    local function stopAllAnimSounds()
        if snd_Fire_1 then snd_Fire_1:Stop() end
        if snd_Fire_2 then snd_Fire_2:Stop() end
    end
    ...
    local function playAction(name)
        ...
        -- per-action audio
        if name == "Fire 1" and snd_Fire_1 then snd_Fire_1:Play() end
        if name == "Fire 2" and snd_Fire_2 then snd_Fire_2:Play() end
    end
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "SolemnLamentIdle.anim", true),
        walk = loadAnim(figure, "SolemnLamentWalk.anim", true),
        sprint = loadAnim(figure, "SolemnLamentRun.anim", true),
        }
        animJump = baseAnims.jump

        actionAnims = {
        ["Fire 1"] = loadAnim(figure, "Solemnlamentfire1.anim", false),
        ["Fire 2"] = loadAnim(figure, "solemnlamentFire2.anim", false),
        ["Fire 3"] = loadAnim(figure, "solemnlamentFire3.anim", false),
        ["Stunt"] = loadAnim(figure, "SolemnLamentStunt.anim", false),
        }

        bgSound = makeSound("SolemnLamentTheme.mp3", hrp, 0.5, true)
        bgSound:Play()

        -- init per-anim sounds
    snd_Fire_1 = makeSound("SolemnLamentfire1sound.mp3", hrp, 0.8, false)
    snd_Fire_2 = makeSound("SolemnLamentfire2sound.mp3", hrp, 0.8, false)
        ...
        ContextActions:BindAction("GM_Fire_1", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Fire 1") end
        end, true, Enum.KeyCode.Z)
        ContextActions:SetTitle("GM_Fire_1", "Fire 1")
        ContextActions:SetPosition("GM_Fire_1", UDim2.new(1, -150, 1, -120))

        ContextActions:BindAction("GM_Fire_2", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Fire 2") end
        end, true, Enum.KeyCode.X)
        ContextActions:SetTitle("GM_Fire_2", "Fire 2")
        ContextActions:SetPosition("GM_Fire_2", UDim2.new(1, -200, 1, -120))

        ContextActions:BindAction("GM_Fire_3", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Fire 3") end
        end, true, Enum.KeyCode.C)
        ContextActions:SetTitle("GM_Fire_3", "Fire 3")
        ContextActions:SetPosition("GM_Fire_3", UDim2.new(1, -250, 1, -120))

        ContextActions:BindAction("GM_Stunt", function(_, inputState, _)
            if inputState == Enum.UserInputState.Begin then playAction("Stunt") end
        end, true, Enum.KeyCode.V)
        ContextActions:SetTitle("GM_Stunt", "Stunt")
        ContextActions:SetPosition("GM_Stunt", UDim2.new(1, -100, 1, -160))
    end
    ...
    m.Destroy = function(figure)
        ...
        ContextActions:UnbindAction("GM_Fire_1")
        ContextActions:UnbindAction("GM_Fire_2")
        ContextActions:UnbindAction("GM_Fire_3")
        ContextActions:UnbindAction("GM_Stunt")
        ...
        stopAllAnimSounds()
    if snd_Fire_1 then snd_Fire_1:Stop() snd_Fire_1:Destroy() snd_Fire_1 = nil end
    if snd_Fire_2 then snd_Fire_2:Stop() snd_Fire_2:Destroy() snd_Fire_2 = nil end
