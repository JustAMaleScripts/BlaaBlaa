-- KnightR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/KnightR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Knight R15 Moveset"
    m.Description  = "Knight R15 Animations"
    m.InternalName = "KnightR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Knight R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "KnightIdle.anim", true),
        walk = loadAnim(figure, "KnightWalk.anim", true),
        jump = loadAnim(figure, "KnightJump.anim", true),
        sprint = loadAnim(figure, "KnightRun.anim", true),
        }
