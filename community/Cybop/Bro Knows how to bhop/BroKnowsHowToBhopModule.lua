-- UhhhhhhReanim/Modules/BroKnowsHowToBhopModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Bro Knows How To Bhop"
	m.Description  = "Your first jump to bhop"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Dont fall", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Uhhh", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("BroKnowsHowToBhopAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("BroKnowsHowToBhopAudio.mp3")
		sndConga.Volume  = 0.8
