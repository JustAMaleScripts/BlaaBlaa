-- ScaredR15Moveset.lua
-- Created with Moveset Creator V6
-- Place in: UhhhhhhReanim/Modules/ScaredR15Moveset.lua
...
AddModule(function()
    ...
    m.Name         = "Scared R15 Moveset"
    m.Description  = "Scared R15 Animations"
    m.InternalName = "ScaredR15Moveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "Scared R15 Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "Scared Idle.anim", true),
        walk = loadAnim(figure, "Scared Walk.anim", true),
        jump = loadAnim(figure, "Scared Jump.anim", true),
        sprint = loadAnim(figure, "Scared Run.anim", true),
        }
