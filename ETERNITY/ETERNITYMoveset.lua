...
-- Place in: UhhhhhhReanim/Modules/ETERNITYMoveset.lua
...
AddModule(function()
    ...
    m.Name         = "ETERNITY Moveset"
    m.Description  = "This Moveset is based in the animations player of the game called ETERNITY"
    m.InternalName = "ETERNITYMoveset"
    ...
    m.Config = function(parent)
        Util_CreateText(parent, "ETERNITY Moveset", 18, Enum.TextXAlignment.Center)
    ...
    m.Init = function(figure)
        ...
        baseAnims = {
        idle = loadAnim(figure, "ETERNITYIdle.anim", true),
        walk = loadAnim(figure, "ETERNITYWalk.anim", true),
        jump = loadAnim(figure, "ETERNITYJump.anim", true),
        sprint = loadAnim(figure, "ETERNITYRun.anim", true),
        }
