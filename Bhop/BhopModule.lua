-- UhhhhhhReanim/Modules/BhopModule.lua
...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Bhop Real"
	m.Description  = "CSGO Bhop"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Ggoooo", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, ".Fast.", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		animator.rig    = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("BhopAnimation.anim"))
		...
		sndConga.SoundId = AssetGetContentId("BhopAudio.mp3")
		sndConga.Volume  = 0.8
