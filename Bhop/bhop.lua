...
table.insert(modules, function()
	...
	m.ModuleType   = "DANCE"
	m.Name         = "Bhop"
	m.Description  = "Bhop music and fast speed"
	m.InternalName = "DANCE_CONGA"
	m.Assets       = {}

	m.Config = function(parent)
		Util_CreateText(parent, "Bhop", 24, Enum.TextXAlignment.Center)
		Util_CreateSeparator(parent)
		Util_CreateText(parent, "Bhop music and fast speed", 14, Enum.TextXAlignment.Center)
	end
	...
	m.Init = function(figure)
		...
		sndConga.SoundId = AssetGetContentId("CSGOBhop.mp3")
		sndConga.Volume  = 0.8
